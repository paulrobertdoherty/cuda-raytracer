...
"/usr/local/lib" )
if(WIN32)
	list( APPEND _glfw3_HEADER_SEARCH_DIRS "${CMAKE_SOURCE_DIR}/include" "C:/Program Files (x86)/glfw/include" )
	list( APPEND _glfw3_LIB_SEARCH_DIRS    "${CMAKE_SOURCE_DIR}/lib"     "C:/Program Files (x86)/glfw/lib-msvc110" )
endif()
